...
- HTTP consumer contracts are generated by `apps/web/test/contracts/http.consumer.pact.test.js` and published to the broker (`PACT_BROKER_BASE_URL`, default `http://localhost:9292`).
