...
- Modified App Sidebar behavior: implemented device-specific visibility rules where navigation labels are permanently visible on desktop and completely hidden (only icons shown) on tablet and mobile viewports, disabling hover expansion for smaller screens.
