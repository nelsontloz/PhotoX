...
export function TimelineSectionList({ sections, selectionMode, selectedIds, onSelectItem, onSelectAllSection, onOpenItem }) {
      ...
      <div className="flex items-end gap-3 mb-4 sticky top-0 bg-background-light/95 dark:bg-background-dark/95 backdrop-blur z-30 py-2 -mx-4 px-4 sm:-mx-8 sm:px-8 transition-all">
        ...
        <div className="ml-auto flex items-center">
          <button
            ...
            onClick={() => onSelectAllSection(section.items)}
          >
            Select all
          </button>
        </div>
