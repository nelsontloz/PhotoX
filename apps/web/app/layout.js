  ...
  return (
    <html lang="en" className="dark">
      <head>
        <link
          rel="stylesheet"
          href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200&icon_names=add,add_photo_alternate,admin_panel_settings,arrow_back,arrow_forward,broken_image,calendar_today,camera,check,check_circle,chevron_left,chevron_right,close,cloud_upload,database,delete,download,edit,error,event,expand_less,expand_more,favorite,folder_open,group,history,image,info,label,location_on,lock,lock_reset,login,mail,menu,notes,notifications,person,photo_album,photo_camera,photo_camera_back,photo_library,progress_activity,remove,search,select_all,settings,share,speed,tune,undo,upload,videocam,visibility,visibility_off"
        />
      </head>
